...
ap.add_argument("--input", type=str, default = "/home/nx/datasets/speed1live2.mp4",
...
cam = cam_list[0]
cam, processor = Prepare_camera(cam)
...
for i in range(NUM_IMGS):
	...
	results = predictor.predict(frame,imgsz=I_SZ,agnostic_nms=True, conf=0.3)
